"""
extratores/extrator_bnz.py

Extrator da BNZ Negócios Imobiliários (bnznegociosimobiliarios.com.br).
...
BASE_URL = "https://www.bnznegociosimobiliarios.com.br"
LISTAGEM_URL_BASE = "https://www.bnznegociosimobiliarios.com.br/imobiliaria/locacao/apartamento-kitnet-casa/arapongas-pr/imoveis/3621"
...
def extrair(max_paginas=20):
    ...
    print(f"Total coletado na BNZ Negócios Imobiliários: {len(todos_imoveis)} imoveis")
