"""
extratores/extrator_almeidasilva.py

Extrator da Almeida Silva Imóveis (almeidasilvaimoveis.com.br).
...
BASE_URL = "https://www.almeidasilvaimoveis.com.br"
LISTAGEM_URL_BASE = "https://www.almeidasilvaimoveis.com.br/imobiliaria/locacao/apartamento-kitnet-casa/arapongas-pr/imoveis/8687"
...
def extrair(max_paginas=20):
    ...
    print(f"Total coletado na Almeida Silva Imóveis: {len(todos_imoveis)} imoveis")
