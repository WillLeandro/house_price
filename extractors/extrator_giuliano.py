"""
extratores/extrator_giuliano.py

Extrator da Imobiliária Giuliano (imobiliariagiuliano.com.br).
...
BASE_URL = "https://www.imobiliariagiuliano.com.br"
LISTAGEM_URL_BASE = "https://www.imobiliariagiuliano.com.br/imobiliaria/locacao/apartamento-casa-sobrado/imoveis/47"
...
def extrair(max_paginas=20):
    ...
    print(f"Total coletado na Imobiliária Giuliano: {len(todos_imoveis)} imoveis")
